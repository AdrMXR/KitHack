...
def check_permissions():
    if os.getuid() == 0:
        ...
        os.system("clear")
        print(
            "{0}[!]{1} ¡Permission denied! Remember to run: {2}sudo {1}python3 KitHack.py".format(
                RED, DEFAULT, GREEN
            )
        )
        exit(0)
...
def main():
    ...
    if option == "01":
        ...
        print(
            "{0}01){1} Backdoor-apk        {2}Add a backdoor to any APK file.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Evil-Droid          {2}Android Backdoor Generator Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} Spade               {2}APK Backdoor Tool Made in Python.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} AhMyth              {2}Android Remote Administration Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} Andspoilt           {2}Run interactive Android exploits on Linux.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} Kwetza              {2}Inject malware into existing Android apps.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Termux              {2}Linux based Android terminal emulator.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Android-Exploits    {2}Collection of Android exploits and hacks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Grabcam             {2}Allows to hack the camera of our victims with a fake page.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Androidpatternlock  {2}Allows to get the pattern lock on Android devices.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        ...
        print(
            "{0}01){1} Winpayloads             {2}Undetectable payload generator in Windows.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} sAINT                   {2}Spyware generator for Windows systems.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} BeeLogger               {2}Gmail Keylogger Generator for Windows.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} FakeImageExploiter      {2}Inject malware into jpg images for Windows.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} Koadic                  {2}Post-Exploit Windows Rootkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} Phantom Evasion         {2}Antivirus Evasion Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Ps1encode               {2}PowerShell-based payload generator and encoder.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} DKMC                    {2}Malicious Payload Evasion Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Cromos                  {2}Inject code into legitimate Chrome Web extensions.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Eternal_scanner         {2}Scanner for Eternal Blue and Eternal Romance exploit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} EternalblueDoublepulsar {2}Metasploit module to exploit the Eternalblue-Doublepulsar vulnerability.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} EternalBlueWinXPWin10   {2}Metasploit Module for EternalBlue from Windows XP SP2 to Windows 10 Pro.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}13){1} Windows-Exploits        {2}Windows Exploits Collection.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} HiddenEye    {2}Modern phishing tool with advanced functionality.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} PhishX       {2}Phishing and Spoofing Generator.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} SocialPhish  {2}Phishing tool with 32 templates + 1 customizable.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} SocialFish   {2}Phishing educational tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} PhisherMan   {2}Phishing tool with 17 templates and working with ngrok.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} Spectre      {2}Supports phishing attacks with almost any website.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Blackeye     {2}Phishing tool with 38 websites available.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} PhEmail      {2}Automate phishing email delivery processes.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Weeman       {2}HTTP Server for Phishing.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Zphisher     {2}Automated phishing tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} AIOPhish     {2}Phishing tool with different options.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} Fluxion        {2}Network Auditing/Social Engineering Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Wifiphisher    {2}WiFi Password Capture Tool Using AP.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} Wifibroot      {2}WPA/WPA2 WiFi Penetration Testing Tool. ".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} Wifite         {2}Run existing wireless auditing tools for you.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} Ettercap       {2}Interceptor/sniffer/logger for switched LANs .".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} Linset         {2}WPA/WPA2 Phishing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} WiFi-Pumpkin   {2}AP framework to easily create fake networks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Wifresti       {2}Find your wireless network password on Windows, Linux and Mac OS.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Evil Limiter   {2}Device bandwidth limiting tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Netool-toolkit {2}MitM pentesting open source toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} Dracnmap       {2}Tool used to exploit networks and collect data with NMAP.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} Airgeddon      {2}Bash script to audit wireless networks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}13){1} Routersploit   {2}Router Penetration Testing Modules.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}14){1} Eaphammer      {2}Kit to perform targeted attacks against WPA2-Enterprise networks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}15){1} VMR-MDK        {2}Script to decrypt WPS wireless networks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}16){1} Wirespy        {2}Allows you to configure fast honeypots to carry out MITM.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}17){1} Wireshark      {2}Network Capture/Analyzing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}18){1} SniffAir       {2}Wireless Pentesting Framework.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}19){1} WifiJammer     {2}WiFi Client/Router Jammer.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}20){1} KawaiiDeauther {2}WiFi DeAuth Attack Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} Cupp            {2}Allows you to create dictionaries specifically for a person.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Facebooker      {2}Facebook Password Bruteforcer Made in Perl.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} BluForce-FB     {2}Facebook Password Bruteforcer.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} Brut3k1t        {2}Bruteforce Attack Kit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} SocialBox       {2}Bruteforce Framework.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} John The Ripper {2}Password Bruteforcing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Hashcat         {2}Hash Cracking Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Brutedum        {2}SSH/FTP/Telnet/PostgreSQL/RDP/VNC/Medusa Bruteforcer.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Facebash        {2}Facebook Bruteforcer Made in Shellscript Using TOR.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Brutespray      {2}Port Scanner/Bruteforcer.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} Pupi            {2}Password Generator Using Personal Information.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} B4r-brute       {2}Facebook Account Cracker Using User ID.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            '{0}13){1} Fb-Hack         {2}Facebook Password "Hack"/Recovery Script.'.format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} SQLmap       {2}SQLi Penetration Testing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} XAttacker    {2}Website Vulnerability Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} Fuxploider   {2}Detect favorable techniques to load web shells or any malicious files.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} Wordpresscan {2}WordPress Vulnerability Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} SiteBroker   {2}Information Collecting/Website Penetration Testing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} NoSQLMap     {2}NoSQL Default Configuration Weakness Exploitation Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Sqli-scanner {2}SQL Injection Vulnerability Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Joomscan     {2}Website Misconfiguration Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Metagoofil   {2}Metadata Extraction Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} Sublist3r    {2}Subdomain Enumeration Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} WAFNinja     {2}Web Application Firewall Attacker.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} Dirsearch    {2}Directory/File Path Bruteforcing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}13){1} XSStrike     {2}Advanced XSS Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}14){1} LinksF1nd3r  {2}Web Component Extractor.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}15){1} D-TECT       {2}Modern Website Penetration Testing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}16){1} Phpsploit    {2}Tool capable of maintaining access to a compromised web server.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} SpoofMAC      {2}MAC Address Spoofing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Ip_spoofing   {2}ARP/HTTP Spoofing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} Arpspoof      {2}ARP Spoofing Attacl Tool Using Linux Kernel Sockets.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} DerpNSpoof    {2}Simple DNS Spoofing Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} DrSpoof       {2}ARP Spoofing Detection Tool For Local Networks.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} GODKILLER     {2}SMS Bomber/Sender.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} NMAP           {2}Network Scanning Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Th3inspector   {2}AIO Information Gathering Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} FBI            {2}Collection of sensitive information on Facebook accounts.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} Infoga         {2}Email Information Extraction Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} Crips          {2}IP Address/Website/DNS Record Lookup Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} BillCipher     {2}Website/IP Address Information Lookup Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} RED_HAWK       {2}Tool to collect information, scan vulnerabilities and trace.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Recon-ng       {2}Information Gathering Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} theHarvester   {2}Collection of emails, names, subdomains, IP addresses and URLs.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} PhoneInfoga    {2}Phone Number Information Lookup Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} Gasmask        {2}AIO Information Gathering Tool #2.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} URLextractor   {2}Website Information Gathering/Reconnaissance Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}13){1} Devploit       {2}Website DNS/WhoIS/IP/GeoIP/Subnet/Port/Host Lookup Tool".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}14){1} ReconDog       {2}AIO Basic Information Gathering Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}15){1} Webkiller      {2}Information Collection Kit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}16){1} Quasar         {2}Information Collection Framework.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}17){1} Info-instagram {2}Instagram Information Extraction Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}18){1} UserScan       {2}Username Lookup/Identity Scanner Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}19){1} XCTR-Hacking   {2}AIO Information Gathering Tool #3.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}20){1} DeadTrap       {2}Phone Number OSINT Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
        ...
        print(
            "{0}01){1} TheFatRat               {2}Malware Compiling Tool For Linux/Windows/MacOS & Android.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}02){1} Msfpc                   {2}Payload Generation Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}03){1} Fcrackzip               {2}Archive Password Cracking Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}04){1} QRLjacker               {2}QR Code Session Hijacking Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}05){1} Lazy                    {2}Script that automates many penetration processes.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}06){1} HTBINVITE               {2}HTB Invite Generator.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}07){1} Ngrok                   {2}Local Reverse Proxy.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}08){1} Bluepot                 {2}Bluetooth Honeypot Written in Java.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}09){1} Setoolkit               {2}Open Source Social Engineering Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}10){1} A2sv                    {2}SSL Vulnerability Scanner.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}11){1} 4nonimizer              {2}IP Anonymizer Using VPN Services.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}12){1} Easysploit              {2}Metasploit Automation Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}13){1} NXcrypt                 {2}Malware Injection Toolkit For Python Files.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}14){1} KnockMail               {2}Email Validity Checker".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}15){1} RkHunter                {2}UNIX Rootkit/Backdoor/Local Exploit Detection Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
        ...
        print(
            "{0}17){1} ZLogger                 {2}Persistent Remote Keylogger for Windows and Linux.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}18){1} Xerosploit              {2}Penetration Testing Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}19){1} Slacksec                {2}Basic Hacking Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}20){1} Katana-Framework        {2}Penetration Testing Framework.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}21){1} Z0172CK-Tools           {2}Z0172CK Hacking Toolkit.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}22){1} Cam-Hack                {2}Advanced Mobile/PC Camera Hacking Tool Using a Link.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}23){1} Onex                    {2}Hacking Tool Library.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}24){1} Ransom0                 {2}Ransomware Creation Tool.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}25){1} Morpheus                {2}TCP/UDP Man-in-the-Middle Attack Suite.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}26){1} FBTOOL                  {2}Facebook Hacking Toolkit".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print(
            "{0}27){1} Venom                   {2}Metasploit Shellcode Generator/Compiler/Driver.".format(
                WHITE, YELLOW, DEFAULT
            )
        )
        print("{0} 0){1} Back".format(WHITE, YELLOW))
