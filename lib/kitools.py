...
def ApkTool():
	os.system('cd tools && cd Android && mkdir ApkTool && cd ApkTool && wget http://download1491.mediafire.com/ifau2q5fyodg/he4vdj2wea7abbv/apktool.zip && unzip apktool.zip && chmod +x * && cp apktool /usr/local/bin/apktool && cp apktool.jar /usr/local/bin/apktool.jar')
	time.sleep(2)
